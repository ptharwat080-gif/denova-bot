...
const { SYSTEM_PROMPT, getOfferStatusPromptAddendum, NO_REPLY_SENTINEL } = require("./knowledge");
...
async function getAiReply(userMessage, history = [], lang) {
  ...
  // Appended fresh on every request so the model always reasons from today's real date instead
  // of a static claim baked into SYSTEM_PROMPT - see getOfferStatusPromptAddendum in knowledge.js.
